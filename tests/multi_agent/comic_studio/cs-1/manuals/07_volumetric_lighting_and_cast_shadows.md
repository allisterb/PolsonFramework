...
> **Staged by the Director.** Verbatim copy of the MCP resource `polson://manual/07`, written to a
> file because subagents in this harness cannot reach `polson://` resources. Content unmodified.
