...
Stage.note('Refining layout balance, typography hierarchy, footer stat cards, segmented bar legend, and line-printer diegetic details.');
...
// Horizontal Fanfold Perforation line (page fold at y = 1310)
const foldY = 1310;
ctx.save();
ctx.setLineDash([8, 8]);
...
// Lower sub-panels in Right Col: Arithmetic Insights & Acceleration Callouts
...
ctx.fillText('FASTEST ACCELERATION: 3 YRS', gapCol.x + 26, accelY + 28);
ctx.font = '700 12px "Segoe UI", Arial, sans-serif';
ctx.fillText('Facebook (2004) -> iPhone (2007) took just 36 months.', gapCol.x + 26, accelY + 50);
ctx.font = '900 11px "Consolas", monospace';
ctx.fillText('MATH: 2007 - 2004 = 3 YEARS (SHORTEST GAP)', gapCol.x + 26, accelY + 72);
