Stage.begin('Critic');
Stage.note('Refinement pass 1. Cape and suit now painted by an SkSL shader that blends the four locally-measured gradient planes with inverse-square-distance weights (a partition of unity), instead of one global gradient. Rationale: the source is a vector illustration whose cape is several paths each with its own linear gradient — a single radial fit it to 24 RGB units mean error and a global quadratic did no better (23.3), because no single surface has that shape. Blending local planes reproduces the actual construction. Structural fixes alongside: legs top-left was exposed left of the belt at y500 (mine 478, reference 576); torso left edge pulled back to 428 at y392; buckle tip extended to y552; emblem yellow tip trimmed.');

const canvas = createCanvas(1024, 1024);
const ctx = canvas.getContext('2d');

// Blend N locally-fitted linear colour planes with inverse-square distance weights.
...
// Measured dark/lit endpoints, one plane per gradient region of the reference.
...
const suitShader = planeBlend([
    { d: [579, 492], cd: H('#1e87e4'), l: [581, 318], cl: H('#45a7f6') },   // torso
    { d: [453, 705], cd: H('#238be6'), l: [507, 565], cl: H('#40a3f3') },   // near leg
    { d: [531, 813], cd: H('#1782e1'), l: [634, 567], cl: H('#48a9f7') },   // far leg
    { d: [681, 222], cd: H('#3f96de'), l: [839, 288], cl: H('#44afff') }    // raised upper arm
]);
...
// Legs: top-left pulled in behind the belt (was exposed at x478 where the reference has cape).
fillShape([
...
fillShape([[584,500],[594,508],[601,520],[601,534],[592,546],[583,552],[574,542],[568,530],
...
fillShape([[744,212],[770,206],[796,198],[816,182],[828,186],[830,202],[830,216],[830,222],
           ...
           [722,248],[730,238],[736,226]], suitShader);
